...
export function LandingPage({ onGetStarted }: LandingPageProps) {
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-cyan-50 to-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-32 relative">
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-3 bg-blue-100 px-4 py-2 rounded-full mb-6">
              ...
              <span className="font-bold text-blue-900">AiC Token Logo</span>
            </div>
            ...
            <button
              ...
              className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white font-semibold px-8 py-4 rounded-lg text-lg shadow-xl hover:shadow-2xl transition-all"
            >
              Get Started
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 max-w-6xl mx-auto mt-16">
            ...
            <div className="bg-white rounded-xl p-4 shadow-lg border border-blue-100 text-center">
              ...
              <p className="text-sm font-semibold text-gray-900">In-House Wallet</p>
            </div>
            <div className="bg-white rounded-xl p-4 shadow-lg border border-blue-100 text-center">
              <DollarSign className="w-8 h-8 text-blue-600 mx-auto mb-2" />
              <p className="text-sm font-semibold text-gray-900">1:1 USDC Pegging</p>
            </div>
            <div className="bg-white rounded-xl p-4 shadow-lg border border-blue-100 text-center">
              <Zap className="w-8 h-8 text-blue-600 mx-auto mb-2" />
              <p className="text-sm font-semibold text-gray-900">Circle SDK Powered</p>
            </div>
            <div className="bg-white rounded-xl p-4 shadow-lg border border-blue-100 text-center">
              <Shield className="w-8 h-8 text-blue-600 mx-auto mb-2" />
              <p className="text-sm font-semibold text-gray-900">Arc Testnet Verified</p>
            </div>
            <div className="bg-white rounded-xl p-4 shadow-lg border border-blue-100 text-center">
              <TrendingUp className="w-8 h-8 text-blue-600 mx-auto mb-2" />
              <p className="text-sm font-semibold text-gray-900">Live Explorer Tracking</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <div className="text-sm text-blue-100">USDC Per Word</div>
            </div>
            <div className="text-center">
              <div className="text-3xl sm:text-4xl font-bold text-white mb-2">⚡</div>
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-blue-100">Gas Fees</div>
            </div>
            <div className="text-center">
              <div className="text-3xl sm:text-4xl font-bold text-white mb-2">✅</div>
              <div className="text-2xl sm:text-3xl font-bold text-white mb-1">100%</div>
              <div className="text-sm text-blue-100">Blockchain Verified</div>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Scrolling Banner */}
      <section className="bg-blue-900 py-4 overflow-hidden">
        <div className="animate-scroll whitespace-nowrap">
          <span className="inline-block text-white font-semibold px-8">Play & Earn USDC</span>
          <span className="inline-block text-blue-300 px-2">•</span>
          <span className="inline-block text-white font-semibold px-8">Get Your AiC Arc Virtual Card</span>
          <span className="inline-block text-blue-300 px-2">•</span>
          <span className="inline-block text-white font-semibold px-8">5% Rewards on Every Purchase</span>
          <span className="inline-block text-blue-300 px-2">•</span>
          <span className="inline-block text-white font-semibold px-8">Spend Anywhere Visa Accepted</span>
          <span className="inline-block text-blue-300 px-2">•</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-8 border border-blue-100">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Wealthy Gaming Economy</h3>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-8 border border-blue-100">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Circle Arc Blockchain</h3>
              <ul className="space-y-3 text-gray-700">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-8 border border-blue-100">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Real Money, Real Freedom</h3>
              <ul className="space-y-3 text-gray-700">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-12">
            <div className="flex gap-6 items-start">
              <div className="flex-shrink-0 w-16 h-16 bg-gradient-to-br from-blue-600 to-cyan-600 rounded-full flex items-center justify-center text-white text-2xl font-bold">
                01
              </div>
              <div className="flex-1">
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Sign Up & Get Your Wallet</h3>
                <p className="text-sm text-blue-600 font-semibold mb-3">Circle SDK In-House Wallet</p>
            ...
            <div className="flex gap-6 items-start">
              ...
              <div className="flex-1">
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Type Blockchain Vocabulary</h3>
                <p className="text-sm text-blue-600 font-semibold mb-3">Blockchain Education Game</p>
                <p className="text-gray-700">
            ...
            <div className="flex gap-6 items-start">
              ...
              <div className="flex-1">
                <h3 className="text-2xl font-bold text-gray-900 mb-2">AI Agent Validates & Rewards</h3>
                <p className="text-sm text-blue-600 font-semibold mb-3">Instant Token Rewards</p>
                <p className="text-gray-700">
            ...
            <div className="flex gap-6 items-start">
              ...
              <div className="flex-1">
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Swap to USDC Anytime</h3>
                <p className="text-sm text-blue-600 font-semibold mb-3">1:1 Pegging with USDC</p>
                <p className="text-gray-700">
            ...
            <div className="flex gap-6 items-start">
              ...
              <div className="flex-1">
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Withdraw to Your Wallet</h3>
                <p className="text-sm text-blue-600 font-semibold mb-3">Cash Out via MetaMask</p>
                <p className="text-gray-700">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-8 border border-blue-100">
              <h3 className="text-xl font-bold text-gray-900 mb-3">Circle Arc L1</h3>
              <p className="text-gray-700">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-8 border border-blue-100">
              <h3 className="text-xl font-bold text-gray-900 mb-3">OpenAI API</h3>
              <p className="text-gray-700">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-8 border border-blue-100">
              <h3 className="text-xl font-bold text-gray-900 mb-3">USDC Stablecoin</h3>
              <p className="text-gray-700">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
              ...
              <p className="text-sm text-blue-100">AI agents interact with DeFi</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
              <div className="text-4xl mb-3">💰</div>
              <h3 className="text-lg font-bold text-white mb-2">USDC Payments</h3>
              <p className="text-sm text-blue-100">Instant stablecoin settlement</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
              <div className="text-4xl mb-3">🤖</div>
              <h3 className="text-lg font-bold text-white mb-2">AI-Native</h3>
              <p className="text-sm text-blue-100">Natural language to payments</p>
            </div>
          </div>

          <button
            onClick={onGetStarted}
            className="inline-flex items-center gap-2 bg-white text-blue-600 hover:bg-blue-50 font-semibold px-8 py-4 rounded-lg text-lg shadow-xl hover:shadow-2xl transition-all"
          >
            Get Started Now
            <ArrowRight className="w-5 h-5" />
          </button>
