...
export function TransactionAccelerator() {
  ...
  return (
    <div className="w-full max-w-2xl bg-gray-900/80 backdrop-blur-sm rounded-xl sm:rounded-2xl shadow-[0_0_50px_rgba(250,204,21,0.3)] border border-yellow-500/30 p-4 sm:p-6">
